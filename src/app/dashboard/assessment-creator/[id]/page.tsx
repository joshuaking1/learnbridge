...
export default function ViewAssessmentPage() {
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            const response = await fetch(`https://learnbridge-teacher-tools-service.onrender.com/api/teacher-tools/assessments/${assessmentId}`, { // http://localhost:3005/api/teacher-tools/assessments/${assessmentId}
                method: 'PUT',
    ...
    if (!assessment) { /* ... assessment not available state ... */ }
